...
export function MobileDashboardNav({ activeView }: { activeView: DashboardView }) {
  return (
    <div className="sticky top-0 z-20 -mx-6 border-y border-white/10 bg-black/80 px-6 py-4 backdrop-blur lg:hidden">
      <div className="mb-3 flex items-center justify-between gap-4">
        ...
        <Link
          href="/predictions"
          className="rounded-full border border-red-500/25 bg-red-500/10 px-4 py-2 text-xs uppercase tracking-[0.18em] text-red-100"
        >
          Predictions
        </Link>
      </div>
